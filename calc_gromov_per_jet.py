...
def main():
    ...
    output_csv = "top_normalized_EMD_gromov_delta_results.csv"
    # output_csv = "QvG_Euclidean_gromov_delta_results_1.csv"
    # output_csv = "QvG_EMD_gromov_delta_results_1.csv"
    # output_csv = "QvG_normalized_EMD_gromov_delta_results_1.csv"
    ...
    with open(output_csv, mode='w', newline='') as file:
        ...
        writer.writerow(["index", "jet_pt", "jet_eta", "jet_label","jet_nparts","delta", "rel_delta", "c"])
    ...
    for i in range(len(four_momentum)):
        ...
        with open(output_csv, mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([i, jet_pt[i], jet_eta[i], jet_label[i],n_parts,delta.item(), rel_delta.item(), c.item()])
