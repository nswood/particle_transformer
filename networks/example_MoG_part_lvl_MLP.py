import torch
from weaver.nn.model.MoG_part_lvl_MLP import *
from weaver.utils.logger import _logger

class MoG_part_lvl_MLPWrapper(torch.nn.Module):
    def __init__(self, **kwargs) -> None:
        super().__init__()
        self.mod = MoG_part_lvl_MLP(**kwargs)
...
def get_model(data_config, **kwargs):
    ...
    model = MoG_part_lvl_MLPWrapper(**cfg)
