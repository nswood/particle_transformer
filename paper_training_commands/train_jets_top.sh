...
for dimension in "${dimensions[@]}"; do
    ...
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 R "$dimension"
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 H "$dimension"
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 S "$dimension"
    
    # Commands with dimensions / 2
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 RxH "$half_dimension"
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 RxS "$half_dimension"
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 HxS "$half_dimension"
    DDP_NGPUS=2 ./train_TopLandscape.sh PMTrans R 64 RxR "$half_dimension" 
